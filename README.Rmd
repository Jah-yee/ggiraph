...
Bugs are reported through [GitHub issues](https://github.com/davidgohel/rvg/issues/new/choose). The issue form requires a reproducible example (a [reprex](https://reprex.tidyverse.org/)) and the output of `sessionInfo()`; reports missing these elements are closed without further response. The more reproducible your report, the more time can go into investigating the bug rather than reconstructing it.

For usage questions ("how do I do X with ggiraph"), please read https://ardata.fr/ggiraph-book/ or ask on [Stack Overflow](https://stackoverflow.com/questions/tagged/r) with the `[r]` tag instead.
